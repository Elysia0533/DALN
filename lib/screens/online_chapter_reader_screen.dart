...
class OnlineChapterReaderScreen extends StatefulWidget {
  ...
  @override
  State<OnlineChapterReaderScreen> createState() =>
      _OnlineChapterReaderScreenState();
}
...
class _OnlineChapterReaderScreenState extends State<OnlineChapterReaderScreen> {
  ...
  Future<void> _loadContent() async {
    ...
    final downloadedContent = await OfflineDownloadService.instance
        .getDownloadedChapterContent(
          widget.plugin.id,
          widget.storyTitle,
          _currentIndex,
        );
          ...
          if (trimmed.startsWith('[') && trimmed.endsWith(']')) {
            try {
              ...
              _pages = list
                  .asMap()
                  .entries
                  .map((e) => Page(e.key, '', e.value.toString()))
                  .toList();
              _isComic = true;
            } catch (_) {
    ...
    try {
      ...
      final pagesList = await VBookEngineChannel.getPageList(
        widget.plugin.id,
        _currentUrl,
      );
      if (mounted) {
        setState(() {
          ...
          _isComic =
              widget.plugin.type == 'comic' ||
              (_pages.length > 1 && isImageUrl);
  ...
  void _goToChapter(int index) {
    if (widget.allChapters == null ||
        index < 0 ||
        index >= widget.allChapters!.length) {
      return;
    }
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    'Khoảng cách dòng: ${settings.lineHeight.toStringAsFixed(1)}',
  ...
  Widget _buildComicPageImage(String rawUrl, ColorScheme colorScheme) {
    ...
    final imgHost = (uri != null && uri.host.isNotEmpty)
        ? '${uri.scheme}://${uri.host}/'
        : '';
          ...
          children: [
                  ...
                  ? InteractiveViewer(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final imgUrl = page.imageUrl.isNotEmpty
                              ? page.imageUrl
                              : page.url;
                            ...
                            children: [
                              ...
                              ReaderSelectableText(
                                _content.isEmpty
                                    ...
                                    : HanVietTranslatorService.instance
                                          .translate(_content),
                                style: settings.bodyTextStyle,
                                onSelectionSpeak: (selectedText, start, end) {
                                  if (_content.isNotEmpty) {
                                    final translated = HanVietTranslatorService
                                        .instance
                                        .translate(_content);
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Slider(
                                      ...
                                      min: 0.0,
                                      max: (widget.allChapters!.length - 1)
                                          .toDouble(),
                                      divisions: widget.allChapters!.length > 1
                                          ? widget.allChapters!.length - 1
                                          : 1,
                                      onChanged: (val) {
                              ...
                              children: [
                                TextButton.icon(
                                  ...
                                  icon: Icon(
                                    ...
                                    size: 16,
                                    color:
                                        HanVietTranslatorService
                                            .instance
                                            .enabled
                                        ? colorScheme.primary
                                        : settings.textColor.withAlpha(150),
                                  ),
                                  label: Text(
                                ...
                                TextButton.icon(
                                  onPressed: () async {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Bắt đầu tải ${chaptersMap.length} chương offline...',
                                        ),
            ...
            Positioned(
              ...
              child: TtsPlayerContainer(
                ...
                onPreviousChapter: _hasPrevious
                    ? () => _goToChapter(_currentIndex - 1)
                    : null,
                onNextChapter: _hasNext
                    ? () => _goToChapter(_currentIndex + 1)
